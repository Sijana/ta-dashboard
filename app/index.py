...
class MainApplication:
    ...
    def __setup_callbacks(self):
        ...
        # Callback to Generate a CSV to Download
        def download_sample_csv(n_clicks):
            sample_df = self.generate_sample_csv()
        ...
        # Managing Data Generation and Page Visibility/Navigation
        @self.__app.callback(
            [
    ...
    # Callback for insights and visualizations (similar to previous implementation)
        ...
        def update_performance_insights(run_demo_state, contents):
            ...
            ml_insights = self.create_ml_insights(df)
    ...
    def create_ml_insights(self, df):
        """
